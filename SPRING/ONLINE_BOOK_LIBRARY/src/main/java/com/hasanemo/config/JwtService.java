...
public class JwtService {
    ...
    private static final String SECRET_KEY = "24432646294A404E635166546A576E5A7234753778214125442A472D4B615064";
    ...
    public String extractUserEmail(String token) {
        // Claims::getSubject -> the subject is/should be the email/username of the user
